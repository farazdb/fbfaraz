...
def i():
    # Your cracking function implementation here
...
if __name__ == "__main__":
    try:
        ...
        print("\n\x1b[1;31m[✖] Process stopped by user (Ctrl+C)\x1b[0m")
        sys.exit(0)
    except requests.exceptions.ConnectionError:
        print("\n\x1b[1;31m[✖] No internet connection!\x1b[0m")
        sys.exit(1)
    except Exception as e:
        print(f"\n\x1b[1;31m[✖] Error: {str(e)}\x1b[0m")
        sys.exit(1)
    finally:
        print("\x1b[1;32m[✔] Script finished\x1b[0m")
